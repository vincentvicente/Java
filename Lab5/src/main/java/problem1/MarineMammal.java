...
public class MarineMammal {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(mammalName, that.mammalName) && Objects.equals(sightingDate,
        that.sightingDate) && Objects.equals(sightingLocation, that.sightingLocation)
        && Objects.equals(height, that.height) && Objects.equals(length, that.length)
        && Objects.equals(weight, that.weight) && mammalGroup == that.mammalGroup;
  }

  @Override
  public int hashCode() {
    return Objects.hash(mammalName, sightingDate, sightingLocation, height, length, weight,
        mammalGroup);
  }
}
